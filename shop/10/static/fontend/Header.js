...
<header id="id_header" className="border-b bg-white font-sans min-h-[60px] px-4 sm:px-10 py-3  tracking-wide relative z-50">

 
  <div className="flex flex-wrap items-center sm:gap-x-10  gap-x-2 ">  {/* logo  + Mennu ngang */}
    ...
    <a href="javascript:void(0)">
      ...
      />
        ...
        {/* Mennu ngang ... */}
        <div id="id_nav" className=" flex gap-x-4" >

        <button id="id_nav_menu" className="md:hidden">
            <svg
              className="w-7 h-7"
              fill="#000"
              viewBox="0 0 20 20"
  ...
  <div className="bg-gray-100 border border-transparent focus-within:border-blue-500 focus-within:bg-transparent flex px-6 rounded-full h-10 lg:w-2/4 mt-3 mx-auto ">
    <svg
      xmlns="http://www.w3.org/2000/svg"
