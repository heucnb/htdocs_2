    ...
    function xoa(event, rIndex) {
       ...
       // post to php with ajax
        ...
        if (gobal_tim_kiem_sua_xoa == "de" )
        {
         ...
         if(data_2d[rIndex][7] =="") { return	_alert("Ngày đẻ không có dữ liệu"); }	
        document.getElementById("id_1").value = data_2d[rIndex][0];
       ...
       // post to php with ajax
        ...
        {
            if(data_2d[rIndex][14] =="") { return	_alert("Ngày cai sữa không có dữ liệu"); }	
       ...
       // post to php with ajax
            ...
            if (gobal_tim_kiem_sua_xoa == "van_de"   )
        {
            ...
            if(data_2d[rIndex][5] =="" ) { return	_alert("Ngày vấn đề không có dữ liệu"); }
       ...
       // post to php with ajax
            ...
            if (gobal_tim_kiem_sua_xoa == "nai_chet_loai"  )
        {
            ...
            if(data_2d[rIndex][16] ==null) { return	_alert("Ngày chết(loại) chưa có dữ liệu"); }	            
       ...
       // post to php with ajax
        ...
        if (gobal_tim_kiem_sua_xoa == "con_chet_loai" )
        {
            ...
            if(data_2d[rIndex][17] =="") { return		alert("Ngày heo con chết(loại) chưa có dữ liệu"); } 
        document.getElementById("id_1").value = data_2d[rIndex][0];
