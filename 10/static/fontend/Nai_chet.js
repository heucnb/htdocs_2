function Nai_chet() {
    ...
    useEffect(() => {  
        $.post("from_heo_nai_chet_loai.php", {post8:$("#id_8").val()}, function(data){ arrayjavascript_so_tai =JSON.parse(data) ; });
...
if (
    ...
    else 
    {
        ...
        $.post("fuction_thêm--from_heo_nái_chết_loại.php", {  post1:$("#id_1").val() , post2:$("#id_2").val() , post3:$("#id_3").val() ,  post8:$("#id_8").val() }, function(data){
