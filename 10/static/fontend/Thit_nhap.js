                      ...
                      id_lo.innerHTML = "" ;
                       for (let index = 0 , len = from.length ; index < len ; index++) { 
                        ...
                        if (su_kien === "Đóng chuồng") {
                            ...
                            $.post("thit_nhap.php", {post1: id_su_kien.textContent , post2: "", post3: "", post5: id_lo.value  , post4:id_ngay.value,  post8:id_8.value , post9:id_su_kien.value ,post10:id_chuyen_chuong.value ,post11:id_so_luong.value ,post12:id_trong_luong.value ,post13:id_nguyen_nhan.value ,post14:id_tong_so_tien.value , post15:id_nguoi_mua.value , post16:id_ky_su.value ,  post17:id_lo_nhap.value ,  post18:id_nguon_nhap.value  }, function(data){
   ...
   useEffect(() => {    
    ...
    id_gui.onclick = function () {
     ...
     let height_table = document.getElementById('id_nhan').getBoundingClientRect().height ;
        $.post("thit_nhap.php", { post2: khu, post3: chuong, post5: id_lo.value  , post4:id_ngay.value,  post8:id_8.value , post9:id_su_kien.value ,post10:id_chuyen_chuong.value ,post11:id_so_luong.value ,post12:id_trong_luong.value ,post13:id_nguyen_nhan.value ,post14:id_tong_so_tien.value , post15:id_nguoi_mua.value , post16:id_ky_su.value ,  post17:id_lo_nhap.value ,  post18:id_nguon_nhap.value }, function(data){
  ...
  return (  <div  className={`flex flex-col w-full h-full  bg-gray-100  `} > 
     ...
     <div  className={` flex grow  mt-2 `} >  
             <div className={` flex flex-col gap-2 shrink-0 ml-2 `} >
                ...
                <div id="id_from"  style={  {  display: 'none',  }  } className={` flex flex-col gap-2 `} > 
                <div> Lô: </div>
                ...
                <div> Chuông chuyển đến: </div>
                <input  id="id_chuyen_chuong"  className={`  border border-sky-500 `}    />  
                <div> Số lượng: </div>
