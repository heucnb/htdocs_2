...
function Rename() {
  ...
  <div   className={' _shadow rounded w-1/2 bg-white  '}  > 
          <div className={'flex flex-wrap'} >  
              <div  className={`mx-5 mt-2 w-full`}  >  Chỉnh sửa thông tin chuồng  </div>
              <div ref = {ref_0 } contentEditable='true'  className={'mx-5  mt-2 p-2 w-full border border-solid border-emerald-400  focus:border-2 focus:border-solid focus:border-emerald-600 outline-0  '} >{para[0]}</div>
