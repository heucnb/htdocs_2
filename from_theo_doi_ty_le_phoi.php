...
<legend>Theo dõi tỷ lệ phối</legend>
	<form >
...
$(document).ready(function(){
	$("#id_gui").click(function(){
		...
		$.post("fuction_thang--from_theo_doi_ty_le_phoi.php", {post1:$("#id_6_year").val()  , post8:$("#id_8").val()}, function(data){
			$("#id_nhan").html(data);	});
...
$(document).ready(function(){
	$("#id_gui_1").click(function(){
		document.getElementById("id_nhan").innerHTML =  "<progress ></progress>"; 
		$.post("fuction_tuan--from_theo_doi_ty_le_phoi.php", {post1:$("#id_6_year").val()  , post8:$("#id_8").val()}, function(data){
			$("#id_nhan").html(data);	});
