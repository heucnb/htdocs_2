...
<legend><input id="id_chon_cot_in_csdl" type="button" value="Sổ theo dõi heo đực"> </legend>
...
<table  > 	
    ...
    <td><fieldset class="fieldset_chung" > 
<legend><input id="id_chon_cot_in_csdl_" type="button" value="Sổ theo dõi heo đực chết(loại)"> </legend>
...
var count_dem_string = dem_string.length;
	...
	count_dem_string > 50 ||
		...
		else 
	    {
			...
			$.post("fuction_thêm--from_heo_đực.php", {post0:$("#id_chon_cot_in_csdl").val() ,  post1:$("#id_1").val() , post2:$("#id_2").val(), post3:$("#id_3").val(),   post8:$("#id_8").val() }, function(data){
			$("#id_nhan").html(data);	});
...
var count_dem_string = dem_string.length;
	...
	if (
		...
		else 
	    {
			...
			$.post("fuction_thêm--from_heo_đực.php", { post0:$("#id_chon_cot_in_csdl_").val() , post1:$("#id_1_").val() , post2:$("#id_2_").val() , post3:$("#id_3_").val() ,  post8:$("#id_8").val() }, function(data){
			$("#id_nhan_").html(data);	});
