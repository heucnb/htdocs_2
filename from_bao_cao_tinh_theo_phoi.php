...
<legend>Báo Cáo Tháng Tính Theo Phối </legend>
	...
	<tr>
		<td  class="tra_bao_cao_tuan"><select id="id_6_year" onclick="myFunction()">
...
$(document).ready(function(){
	$("#id_gui").click(function(){
		...
		$.post("fuction_thang__from_bao_cao_tinh_theo_phoi.php", {post1:$("#id_6_year").val()  , post8:$("#id_8").val()}, function(data){
			$("#id_nhan").html(data);	});
...
$(document).ready(function(){
	$("#id_gui_1").click(function(){
		document.getElementById("id_nhan").innerHTML =  "<progress ></progress>"; 
		$.post("fuction_tuan__from_bao_cao_tinh_theo_phoi.php", {post1:$("#id_6_year").val()  , post8:$("#id_8").val()}, function(data){
			$("#id_nhan").html(data);	});
