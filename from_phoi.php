...
<legend  ><input id="id_chon_cot_in_csdl" type="button" value="Sổ phối"> </legend>
<form   >   
<table  > 	
	...
	<tr>
		<td  > <table  > 							
		    	...
		    	<tr  >
				<td  > <input id="id_3" name="name_3" type="text" /> </td>	<td  ><label  id="id_tim_2"  type="text" >Nhập theo số tai gợi ý</label><input type="checkbox" id="id_checkbox2"  >	</td>						
				</tr>						
				...
				<tr  >			
				<td  >Biểu hiện khi phối:	</td>			
				</tr>			
				<tr  >
				<td  > <input id="id_5" name="name_5" type="text" />	 </td>						
				</tr>				
...
var arrayjavascript_so_tai = <?php echo json_encode($arraymysql_sum); ?>; // ***** gán mảng 2 chiều từ php vào javácript
...
var arrayjavascript_so_tai_duc = <?php echo json_encode($arraymysql_4_2); ?>; // ***** gán mảng 2 chiều từ php vào javácript
// biến mảng 2 chiều 1 cột thành string sau đó tìm từ ở input gắn với sự kiện thay đổi ngay lập tức cho đực
$(document).ready(function(){
$('#id_3').each(function() {
    // Save current value of element
    $(this).data('oldVal', $(this));
    ...
    $(this).bind("propertychange keyup input paste", function(event){
       ...
       if ($(this).data('oldVal') != $(this).val()) {
        ...
        // Do action: paste code mình viết ở đây
    var gia_tri_tim = document.getElementById('id_3').value;			
