...
<legend><input id="id_chon_cot_in_csdl" type="button" value="Sổ cai sữa"> </legend>
<form   >   
<table  > 	
...
$(document).ready(function(){
	...
	{return document.getElementById('id_nhan').innerHTML="Số heo cai sữa  phải định dạng số từ 0-30 và không được để trống";  }
