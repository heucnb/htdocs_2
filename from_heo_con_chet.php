...
<legend><input id="id_chon_cot_in_csdl" type="button" value="Sổ heo con chết theo mẹ"> </legend>
...
<table  > 	
	...
	<tr>
		<td  > <table  > 							
				...
				<tr  >
				<td  > <input id="id_3" name="name_3" type="text" /> </td>						
				</tr>						
							
				<tr  >			
				<td  >Nguyên nhân heo con chết:	</td>			
				</tr>			
				<tr  >
				<td  > <select id="id_4" name="name_4">
...
$(document).ready(function(){
	...
	{return document.getElementById('id_nhan').innerHTML="Số heo con chết  phải định dạng số từ 0-50 và không được để trống";  }
