...
$(document).ready(function(){
	$("#id_gui").click(function(){
		...
		$.post("fuction_thang__from_bao_cao_thang.php",  {post1:$("#id_6_year").val()  , post8:$("#id_8").val()}, function(data){
			$("#id_nhan").html(data);	});
...
$(document).ready(function(){
	$("#id_gui_1").click(function(){
		...
		$.post("fuction_tuan__from_bao_cao_thang.php", {post1:$("#id_6_year").val()  , post8:$("#id_8").val()}, function(data){
			$("#id_nhan").html(data);	});
